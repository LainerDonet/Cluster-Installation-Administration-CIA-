...
network --device=eth0 --onboot=yes --bootproto=static --ip=172.17.1.4 --netmask=255.255.0.0 --nodns  --hostname=nodo4
...
curl -s 172.17.253.253/nodo4#CIA_POST:BEGIN+++++++++++++++ &>/dev/null 
bash -x /cia/cluster_install/bin/ci_post-install-node nodo4 172.17.1.4 255.255.0.0 ac:1f:6b:49:89:f0 /usr/cia-7.6.1810 172.17.253.253 
curl -s 172.17.253.253/nodo4#CIA_POST:END+++++++++++++++ &>/dev/null 
%end
...
curl -s 172.17.253.253/nodo4#CIA_POST:CIA.SHELL &>/dev/null 
done 
