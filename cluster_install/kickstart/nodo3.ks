...
network --device=eth0 --onboot=yes --bootproto=static --ip=172.17.1.3 --netmask=255.255.0.0 --nodns  --hostname=nodo3
...
curl -s 172.17.253.253/nodo3#CIA_POST:BEGIN+++++++++++++++ &>/dev/null 
bash -x /cia/cluster_install/bin/ci_post-install-node nodo3 172.17.1.3 255.255.0.0 0c:c4:7a:a9:a9:a8 /usr/cia-7.6.1810 172.17.253.253 
curl -s 172.17.253.253/nodo3#CIA_POST:END+++++++++++++++ &>/dev/null 
%end
...
curl -s 172.17.253.253/nodo3#CIA_POST:CIA.SHELL &>/dev/null 
done 
