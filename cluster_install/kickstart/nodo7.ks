...
network --device=eth0 --onboot=yes --bootproto=static --ip=172.17.1.7 --netmask=255.255.0.0 --nodns  --hostname=nodo7
...
curl -s 172.17.253.253/nodo7#CIA_POST:BEGIN+++++++++++++++ &>/dev/null 
bash -x /cia/cluster_install/bin/ci_post-install-node nodo7 172.17.1.7 255.255.0.0 7C:C2:55:2E:0B:4E /usr/cia-7.6.1810 172.17.253.253 
curl -s 172.17.253.253/nodo7#CIA_POST:END+++++++++++++++ &>/dev/null 
%end
...
curl -s 172.17.253.253/nodo7#CIA_POST:CIA.SHELL &>/dev/null 
done 
