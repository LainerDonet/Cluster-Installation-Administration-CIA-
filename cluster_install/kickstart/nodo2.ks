...
network --device=eth0 --onboot=yes --bootproto=static --ip=172.17.1.2 --netmask=255.255.0.0 --nodns  --hostname=nodo2
...
curl -s 172.17.253.253/nodo2#CIA_POST:BEGIN+++++++++++++++ &>/dev/null 
bash -x /cia/cluster_install/bin/ci_post-install-node nodo2 172.17.1.2 255.255.0.0 0c:c4:7a:69:55:e0 /usr/cia-7.6.1810 172.17.253.253 
curl -s 172.17.253.253/nodo2#CIA_POST:END+++++++++++++++ &>/dev/null 
%end
...
curl -s 172.17.253.253/nodo2#CIA_POST:CIA.SHELL &>/dev/null 
done 
