...
network --device=eth0 --onboot=yes --bootproto=static --ip=172.17.1.2 --netmask=255.255.0.0 --nodns  --hostname=node2
...
mkdir /cia                                 
mount -o nolock 172.17.100.100:/home/panzer/Escritorio/cia-7.6.1810 /cia  
curl -s 172.17.100.100/node2#CIA_POST:BEGIN+++++++++++++++ &>/dev/null 
bash -x /cia/cluster_install/bin/ci_post-install-node node2 172.17.1.2 255.255.0.0 ac:1f:6b:63:e9:12 /home/panzer/Escritorio/cia-7.6.1810 172.17.100.100 
curl -s 172.17.100.100/node2#CIA_POST:END+++++++++++++++ &>/dev/null 
%end
...
curl -s 172.17.100.100/node2#CIA_POST:CIA.SHELL &>/dev/null 
done 
